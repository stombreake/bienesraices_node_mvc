...
const emailRegistro = async (datos) => {
    ...
    await transport.sendMail({
        ...
        <a href="${process.env.BACKEND_URL}:${'3' ?? 3000}/auth/confirmar/${token}"> Confirmar Cuenta</a></p>
...
const emailOlvidePassword = async (datos) => {
    ...
    await transport.sendMail({
        ...
        <a href="${process.env.BACKEND_URL}:${'3' ?? 3000}/auth/olvide-password/${token}"> Reestablecer Password</a></p>
