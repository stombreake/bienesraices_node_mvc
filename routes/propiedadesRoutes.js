...
router.post('/propiedades/crear',
    ...
    body('estacionamiento').isNumeric().withMessage('Selecciona la Cantidadm de Estacionamientos'),
    body('wc').isNumeric().withMessage('Selecciona ula Cantidad de Baños'),
...
router.post('/prpoiedades/eliminar/:id',
    protegerRuta,
    eliminar,
)
